...
if (isset($_POST['submit'])) {
    ...
    $checkSql = "SELECT * FROM categories WHERE categories = :categories";
    $checkStmt = $connect->prepare($checkSql);
    $checkStmt->bindParam(':categories', $categories, PDO::PARAM_STR);
    $checkStmt->execute();
    ...
    if ($existingCategory) {
        ...
        $insertSql = "INSERT INTO categories (categories, status) VALUES (?, '1')";
        $insertStmt = $connect->prepare($insertSql);
        $insertStmt->execute([$categories]);
