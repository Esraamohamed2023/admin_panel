...
if (isset($_POST['submit'])) {
    ...
    $email = $_POST['email'];
    $pw = $_POST['password'];
    $active=$_POST['isAdmin'];


    $active = isset($_POST['isAdmin']) ? 1 : 0;

    $sql2 = "INSERT INTO admin_users (name, username, email, password, isAdmin) VALUES (?, ?, ?, ?, ?)";
    $stmt2 = $connect->prepare($sql2);
    
    $stmt2->execute([$name, $username, $email, $pw, $active]);
}
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="isAdmin">
												</label>
											</div>
										</div>
										<div class="item form-group">
