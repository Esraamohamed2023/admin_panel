					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form  action='photo.php' id="demo-form2" class="form-horizontal form-label-left" metod='GET' >
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="photo-date">Photo Date <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="photo-date" required="required" class="form-control" name="date">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<?php $stmt = $connect->prepare("SELECT id,categories FROM categories");
...
<?php } ?>
										...
										<div class="item form-group">
											...
											<input class="btn btn-primary" type="reset" name="cancel" value="Cancel">
