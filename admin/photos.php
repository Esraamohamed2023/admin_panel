                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
$stmt = $connect->prepare("SELECT date,name, status,id FROM products");
$stmt->execute();
...
<tbody>
  <tr>
    ...
    <td><a href='./edit.php?id=<?php echo $row["id"]; ?>'><img src="./images/edit.png" alt="Edit"></a>
    <td><a href='./edit.php?id=<?php echo $row["id"]; ?>'><img src="./images/delete.png" alt="Delete"></a></td>
  </tr>
</tbody>
<?php
}
