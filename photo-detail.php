...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <?php if ($photoDetails) { ?>
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary"><?php echo $photoDetails['name'] ;?></h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12 text-center">
                <img src="img/<?php echo $photoDetails['image'] ;?>" alt="Image" class="img-fluid">
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="mb-4 d-flex flex-wrap">
                        <div class="mr-4 mb-2">
                            <span class="tm-text-gray-dark">Dimension: </span><span class="tm-text-primary"><?php echo $photoDetails['dimension'] ;?></span>
                        </div>
                        <div class="mr-4 mb-2">
                            <span class="tm-text-gray-dark">Format: </span><span class="tm-text-primary"><?php echo $photoDetails['format'] ;?></span>
                        </div>
                    </div>
                    <div class="mb-4">
                        <h3 class="tm-text-gray-dark mb-3">License</h3>
                        <p><?php echo $photoDetails['linecse'] ;?></p>
                    </div>
                    <?php }} ?>
                    <?php foreach ($result as $row) {?>
                    <div>
                        <h3 class="tm-text-gray-dark mb-3">Tags</h3>
                        <a href="#" class="tm-text-primary mr-4 mb-2 d-inline-block"><?php echo $row['categories'] ?></a>
